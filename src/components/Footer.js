...
function Footer() {
  return (
    <div className='space-y-4 border-t pt-10 ml-10 mt-10 mb-10 mr-10 lg:flex lg:flex-row lg:justify-between lg:ml-64 lg:mr-64 lg:pt-5 lg:items-center lg:border-t lg:mt-20 lg:pb-7'>
